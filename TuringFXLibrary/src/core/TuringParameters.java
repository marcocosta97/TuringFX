...
public class TuringParameters {
    ...
    /**
     * Da 230.0.0.0 a 232.0.0.0 sono liberi e si coprono circa 30 milioni di
     * indirizzi, dovrebbero bastare
     */
    ...
    public static final int MAX_SECTION_LENGTH = 10 * 1000 * 1000; /* cca 10 MB, max 20 MB (dipende dalla codifica) */
