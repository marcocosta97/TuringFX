...
public class Document {    
    ...
    private static final int MAX_BUFFER_SIZE = 5000000; // 5MB
    ...
    public void endSectionEditing(String newContent, int section, User user) throws InvalidSectionException, 
        ...
        if(newContent.length() > TuringParameters.MAX_SECTION_LENGTH)
            throw new IOException("La sezione è troppo grande, errore");
